...
public class DiagramSwitch<T> extends Switch<T> {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>DNode DAttribute</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>DNode DAttribute</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDNodeDAttribute(DNodeDAttribute object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>DArrow DAttribute</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>DArrow DAttribute</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDArrowDAttribute(DArrowDAttribute object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>DData Node</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>DData Node</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDDataNode(DDataNode object) {
		return null;
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DiagramPackage.DDATA_NODE: {
				DDataNode dDataNode = (DDataNode)theEObject;
				T result = caseDDataNode(dDataNode);
				if (result == null) result = caseDElement(dDataNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DiagramPackage.DNODE_DATTRIBUTE: {
				DNodeDAttribute dNodeDAttribute = (DNodeDAttribute)theEObject;
				T result = caseDNodeDAttribute(dNodeDAttribute);
				if (result == null) result = caseDElement(dNodeDAttribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DiagramPackage.DARROW_DATTRIBUTE: {
				DArrowDAttribute dArrowDAttribute = (DArrowDAttribute)theEObject;
				T result = caseDArrowDAttribute(dArrowDAttribute);
				if (result == null) result = caseDElement(dArrowDAttribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}

 ...
 *   <li>{@link no.hib.dpf.core.impl.SpecificationImpl#getMetalevel <em>Metalevel</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SpecificationImpl extends EObjectImpl implements Specification {
	...
	/**
	 * The default value of the '{@link #getMetalevel() <em>Metalevel</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getMetalevel()
	 * @generated
	 * @ordered
	 */
	protected static final int METALEVEL_EDEFAULT = -1;

	/**
	 * The cached value of the '{@link #getMetalevel() <em>Metalevel</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getMetalevel()
	 * @generated
	 * @ordered
	 */
	protected int metalevel = METALEVEL_EDEFAULT;
...
/**
	 ...
	 */
	@Override
	public void setMetalevel(int newMetalevel) {
		int oldMetalevel = metalevel;
		metalevel = newMetalevel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.SPECIFICATION__METALEVEL, oldMetalevel, metalevel));
	}
...
//	}
	...
	public Specification getTemplateSpecification() {
		if(this.getMetalevel() >= 0){
			Assert.isNotNull(getType());
			return getType().getTemplateSpecification();
		}else if(this.getMetalevel() < -1){
			return null; //... the template is at a higher metalevel
		}else{
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case CorePackage.SPECIFICATION__SIGNATURE_FILE:
				...
				return;
			case CorePackage.SPECIFICATION__SIGNATURE:
				setSignature(DPFCoreConstants.DEFAULT_SIGNATURE);
				return;
			case CorePackage.SPECIFICATION__TYPE:
				setType(DPFCoreConstants.REFLEXIVE_SPECIFICATION);
				return;
			case CorePackage.SPECIFICATION__METALEVEL:
				metalevel = METALEVEL_EDEFAULT;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case CorePackage.SPECIFICATION__SIGNATURE:
				return signature != null && signature != DPFCoreConstants.DEFAULT_SIGNATURE;
			case CorePackage.SPECIFICATION__TYPE:
				return type != null && type != DPFCoreConstants.REFLEXIVE_SPECIFICATION;
			case CorePackage.SPECIFICATION__METALEVEL:
				return metalevel != METALEVEL_EDEFAULT;
		}

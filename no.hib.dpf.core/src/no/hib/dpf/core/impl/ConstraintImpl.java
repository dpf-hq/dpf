 ...
 *   <li>{@link no.hib.dpf.core.impl.ConstraintImpl#getArrowAttributes <em>Arrow Attributes</em>}</li>
 *   <li>{@link no.hib.dpf.core.impl.ConstraintImpl#getNodeAttributes <em>Node Attributes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConstraintImpl extends IDObjectImpl implements Constraint {
	...
	/**
	 * The cached value of the '{@link #getArrowAttributes() <em>Arrow Attributes</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<ArrowAttribute> getArrowAttributes() {
		if (arrowAttributes == null) {
			arrowAttributes = new EObjectWithInverseResolvingEList.ManyInverse<ArrowAttribute>(ArrowAttribute.class, this, CorePackage.CONSTRAINT__ARROW_ATTRIBUTES, CorePackage.ARROW_ATTRIBUTE__CONSTRAINTS);
		}
	...
	public EList<NodeAttribute> getNodeAttributes() {
		if (nodeAttributes == null) {
			nodeAttributes = new EObjectWithInverseResolvingEList.ManyInverse<NodeAttribute>(NodeAttribute.class, this, CorePackage.CONSTRAINT__NODE_ATTRIBUTES, CorePackage.NODE_ATTRIBUTE__CONSTRAINTS);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case CorePackage.CONSTRAINT__ARROW_ATTRIBUTES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getArrowAttributes()).basicAdd(otherEnd, msgs);
			case CorePackage.CONSTRAINT__NODE_ATTRIBUTES:
	...
	/**
	 * TODO needs improvement (dont want to return -1 if it fails, 
	 * because -1 is the default metalevel. Returning -1 would be misleading)
	 * 

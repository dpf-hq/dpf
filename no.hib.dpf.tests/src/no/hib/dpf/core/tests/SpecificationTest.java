 ...
 * <ul>
 *   <li>{@link no.hib.dpf.core.Specification#createGraph(java.lang.String) <em>Create Graph</em>}</li>
 *   <li>{@link no.hib.dpf.core.Specification#createConstraint(no.hib.dpf.core.Predicate, java.lang.String, no.hib.dpf.core.GraphHomomorphism, org.eclipse.emf.common.util.EList, org.eclipse.emf.common.util.EList, org.eclipse.emf.common.util.EList, org.eclipse.emf.common.util.EList) <em>Create Constraint</em>}</li>
 *   <li>{@link no.hib.dpf.core.Specification#validate() <em>Validate</em>}</li>
 *   <li>{@link no.hib.dpf.core.Specification#getTemplateSpecification() <em>Get Template Specification</em>}</li>
 * </ul>
 * </p>
 * @generated
 */
public class SpecificationTest extends TestCase {
	...
	/**
	 * Tests the '{@link no.hib.dpf.core.Specification#createGraph(java.lang.String) <em>Create Graph</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
...
//		fail();
	...
	/**
	 * Tests the '{@link no.hib.dpf.core.Specification#createConstraint(no.hib.dpf.core.Predicate, java.lang.String, no.hib.dpf.core.GraphHomomorphism, org.eclipse.emf.common.util.EList, org.eclipse.emf.common.util.EList, org.eclipse.emf.common.util.EList, org.eclipse.emf.common.util.EList) <em>Create Constraint</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
...
//		fail();
	...
	/**
	 * Tests the '{@link no.hib.dpf.core.Specification#validate() <em>Validate</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
...
//		fail();
	...
	/**
	 * Tests the '{@link no.hib.dpf.core.Specification#getTemplateSpecification() <em>Get Template Specification</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

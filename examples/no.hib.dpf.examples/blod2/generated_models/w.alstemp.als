...
check{all trans: Trans|//mulitplicity on :Order Sample->Select Book pre-examination[0,1]
...
check{all trans: Trans|//mulitplicity on :Select Book pre-examination->Send Sample Order[0,1]
...
check{all trans: Trans|//mulitplicity on :perform transfusion->Identify nurse, log transfusion[0,1]
...
check{all trans: Trans|//mulitplicity on out time less than 4h:Collect Blood->Scan Blood Product[0,1]
all n:(NCollectBlood&trans.target.nodes)| lone e:(Aouttimelessthan4h&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on :Show Nurse Info->Scan Patient Wristband[0,1]
all n:(NShowNurseInfo&trans.target.nodes)| lone e:(ANShowNurseInfoNScanPatientWristband&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on Patient has not been bloodtyped:Order Sample->Select Blod Typeing[0,1]
all n:(NOrderSample&trans.target.nodes)| lone e:(APatienthasnotbeenbloodtyped&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on :Select Blod Typeing->Send Sample Order[0,1]
all n:(NSelectBlodTypeing&trans.target.nodes)| lone e:(ANSelectBlodTypeingNSendSampleOrder&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (Nurse{name}):Get Nurse Info->Show Nurse Info[0,1]
all n:(NGetNurseInfo&trans.target.nodes)| lone e:(ANursename&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on Nurse is not found:Get Nurse Info->Scan Nurse Card[0,1]
all n:(NGetNurseInfo&trans.target.nodes)| lone e:(ANurseisnotfound&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (Barcode):Scan Patient Wristband->Get Patient Info[0,1]
all n:(NScanPatientWristband&trans.target.nodes)| lone e:(ABarcode&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (Patient{name, ID, gender, blodtype, screening}):Get Patient Info->Show Patient Info[0,1]
all n:(NGetPatientInfo&trans.target.nodes)| lone e:(APatientnameIDgenderblodtypescreening&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on Patient is not found:Get Patient Info->Scan Patient Wristband[0,1]
all n:(NGetPatientInfo&trans.target.nodes)| lone e:(APatientisnotfound&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (Sample):Get Sample Info->Scann Patient Wristband[0,1]
all n:(NGetSampleInfo&trans.target.nodes)| lone e:(ASample&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (Barcode):Scan Sample->Get Sample Info[0,1]
all n:(NScanSample&trans.target.nodes)| lone e:(ABarcode1&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (Barcode):Scann Patient Wristband->Get Patient Info[0,1]
all n:(NScannPatientWristband&trans.target.nodes)| lone e:(ABarcode2&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (Patient):Get Patient Info->Send Sample[0,1]
all n:(NGetPatientInfo0&trans.target.nodes)| lone e:(APatient&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on Blood have not been ordered:Send Sample Order->Order Blood[0,1]
all n:(NSendSampleOrder&trans.target.nodes)| lone e:(ABloodhavenotbeenordered&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on :Collect Sample->Scan Sample[0,1]
all n:(NCollectSample&trans.target.nodes)| lone e:(ANCollectSampleNScanSample&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on :Order Blood->Select Blood Product[0,1]
all n:(NOrderBlood&trans.target.nodes)| lone e:(ANOrderBloodNSelectBloodProduct&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (Barcode):Select Blood Product->Get Doctor Info[0,1]
all n:(NSelectBloodProduct&trans.target.nodes)| lone e:(ABarcode3&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (Doctor):Get Doctor Info->Select Department[0,1]
all n:(NGetDoctorInfo&trans.target.nodes)| lone e:(ADoctor&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (Department):Select Department->Send Blood Order[0,1]
all n:(NSelectDepartment&trans.target.nodes)| lone e:(ADepartment&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on Samples have not been sent:Send Blood Order->Scan Sample[0,1]
all n:(NSendBloodOrder&trans.target.nodes)| lone e:(ASampleshavenotbeensent&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on Sample is not for the patient:Get Patient Info->Scan Sample[0,1]
all n:(NGetPatientInfo0&trans.target.nodes)| lone e:(ASampleisnotforthepatient&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on Blood have not been ordered:Send Sample->Order Blood[0,1]
all n:(NSendSample&trans.target.nodes)| lone e:(ABloodhavenotbeenordered4&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (Barcode,  Patient):Scan Blood Product->Verify Blood Product[0,1]
all n:(NScanBloodProduct&trans.target.nodes)| lone e:(ABarcodePatient&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on The blood Product is not for the patient:Verify Blood Product->Stop Transfusion, Contact AIT[0,1]
all n:(NVerifyBloodProduct&trans.target.nodes)| lone e:(AThebloodProductisnotforthepatient&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on The blood is for the patient:Verify Blood Product->perform transfusion[0,1]
all n:(NVerifyBloodProduct&trans.target.nodes)| lone e:(AThebloodisforthepatient&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (Patient{temp, pressure_high, pressure_low, pulse}):Measure temperature, blood pressure and pulse->Store Patient Condition[0,1]
...
check{all trans: Trans|//mulitplicity on More blood:perform transfusion->Scan Blood Product[0,1]
all n:(Nperformtransfusion&trans.target.nodes)| lone e:(AMoreblood&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (Barcode):Scan Nurse Card->Get Nurse Info[0,1]
all n:(NScanNurseCard&trans.target.nodes)| lone e:(ABarcode5&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on :Show Patient Info->Order Blood[0,1]
all n:(NShowPatientInfo&trans.target.nodes)| lone e:(ANShowPatientInfoNOrderBlood&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (Reaction{type}):perform transfusion->Register Reaction[0,1]
all n:(Nperformtransfusion&trans.target.nodes)| lone e:(AReactiontype&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (Transfusion, Nurse):Identify nurse, log transfusion->Store Transfusion[0,1]
all n:(NIdentifynurselogtransfusion&trans.target.nodes)| lone e:(ATransfusionNurse&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on out time less then 0.5h:Collect Blood->Put Blood Into refrigertor[0,1]
all n:(NCollectBlood&trans.target.nodes)| lone e:(Aouttimelessthen05h&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on out time less than 4h:Put Blood Into refrigertor->Scan Blood Product[0,1]
all n:(NPutBloodIntorefrigertor&trans.target.nodes)| lone e:(Aouttimelessthan4h6&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (BloodOrder{quantity, expectTime}):Send Blood Order->Order Blood Product[0,1]
all n:(NSendBloodOrder&trans.target.nodes)| lone e:(ABloodOrderquantityexpectTime&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (Blood*):Order Blood Product->Collect Blood[0,1]
all n:(NOrderBloodProduct&trans.target.nodes)| lone e:(ABlood&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on :Send Sample->Collect Blood[0,1]
all n:(NSendSample&trans.target.nodes)| lone e:(ANSendSampleNCollectBlood&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on bloodtype is unknown or screening is not done or invalid(screen is valid within 4 days):Show Patient Info->Order Sample[0,1]
...
check{all trans: Trans|//mulitplicity on Samples have not been ordered:Send Blood Order->Order Sample[0,1]
all n:(NSendBloodOrder&trans.target.nodes)| lone e:(ASampleshavenotbeenordered&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on :perform transfusion->Measure temperature, blood pressure and pulse[0,1]
...
check{all trans: Trans|//mulitplicity on :Measure temperature, blood pressure and pulse->perform transfusion[0,1]
...
check{all trans: Trans|//mulitplicity on (Sample Label File*):Send Sample Order->Print Sample Label[0,1]
all n:(NSendSampleOrder&trans.target.nodes)| lone e:(ASampleLabelFile&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on (Label*):Print Sample Label->Collect Sample[0,1]
all n:(NPrintSampleLabel&trans.target.nodes)| lone e:(ALabel&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on :Init->Scan Nurse Card[0,1]
all n:(NInit&trans.target.nodes)| lone e:(ANInitNScanNurseCard&trans.target.arrows)|e.src=n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//surjective on :Select Book pre-examination->Send Sample Order
all n:(NSendSampleOrder&trans.target.nodes)| some e:(ANSelectBookpreexaminationNSendSampleOrder&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//surjective on :perform transfusion->Identify nurse, log transfusion
...
check{all trans: Trans|//surjective on :Order Sample->Select Book pre-examination
...
check{all trans: Trans|//surjective on Patient has not been bloodtyped:Order Sample->Select Blod Typeing
all n:(NSelectBlodTypeing&trans.target.nodes)| some e:(APatienthasnotbeenbloodtyped&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//XOR constraint between (Patient):Get Patient Info->Send Sample and Sample is not for the patient:Get Patient Info->Scan Sample
...
check{all trans: Trans|//XOR constraint between Nurse is not found:Get Nurse Info->Scan Nurse Card and (Nurse{name}):Get Nurse Info->Show Nurse Info
...
check{all trans: Trans|//XOR constraint between Patient is not found:Get Patient Info->Scan Patient Wristband and (Patient{name, ID, gender, blodtype, screening}):Get Patient Info->Show Patient Info
...
check{all trans: Trans|//XOR constraint between The blood Product is not for the patient:Verify Blood Product->Stop Transfusion, Contact AIT and The blood is for the patient:Verify Blood Product->perform transfusion
...
check{all trans: Trans|//surjective on (Patient):Get Patient Info->Send Sample
all n:(NSendSample&trans.target.nodes)| some e:(APatient&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//surjective on (Barcode):Scann Patient Wristband->Get Patient Info
all n:(NGetPatientInfo0&trans.target.nodes)| some e:(ABarcode2&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//surjective on (Sample):Get Sample Info->Scann Patient Wristband
all n:(NScannPatientWristband&trans.target.nodes)| some e:(ASample&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//surjective on (Barcode):Scan Sample->Get Sample Info
all n:(NGetSampleInfo&trans.target.nodes)| some e:(ABarcode1&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//surjective on (Barcode):Scan Patient Wristband->Get Patient Info
all n:(NGetPatientInfo&trans.target.nodes)| some e:(ABarcode&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//xorsurj Patient is not found 
...
check{all trans: Trans|//surjective on (Department):Select Department->Send Blood Order
all n:(NSendBloodOrder&trans.target.nodes)| some e:(ADepartment&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//surjective on (Doctor):Get Doctor Info->Select Department
all n:(NSelectDepartment&trans.target.nodes)| some e:(ADoctor&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//surjective on (Barcode):Select Blood Product->Get Doctor Info
all n:(NGetDoctorInfo&trans.target.nodes)| some e:(ABarcode3&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//xor3surj Blood have not been ordered Blood have not been ordered 
...
check{all trans: Trans|//xorsurj Sample is not for the patient 
...
check{all trans: Trans|//imply Samples have not been sent 
...
check{all trans: Trans|//surjective on (Reaction{type}):perform transfusion->Register Reaction
all n:(NRegisterReaction&trans.target.nodes)| some e:(AReactiontype&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//surjective on (Barcode):Scan Nurse Card->Get Nurse Info
all n:(NGetNurseInfo&trans.target.nodes)| some e:(ABarcode5&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//surjective on (Nurse{name}):Get Nurse Info->Show Nurse Info
all n:(NShowNurseInfo&trans.target.nodes)| some e:(ANursename&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//surjective on (Patient{name, ID, gender, blodtype, screening}):Get Patient Info->Show Patient Info
all n:(NShowPatientInfo&trans.target.nodes)| some e:(APatientnameIDgenderblodtypescreening&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//surjective on (Patient{temp, pressure_high, pressure_low, pulse}):Measure temperature, blood pressure and pulse->Store Patient Condition
...
check{all trans: Trans|//surjective on (Transfusion, Nurse):Identify nurse, log transfusion->Store Transfusion
all n:(NStoreTransfusion&trans.target.nodes)| some e:(ATransfusionNurse&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//surjective on The blood Product is not for the patient:Verify Blood Product->Stop Transfusion, Contact AIT
...
check{all trans: Trans|//surjective on (Barcode,  Patient):Scan Blood Product->Verify Blood Product
all n:(NVerifyBloodProduct&trans.target.nodes)| some e:(ABarcodePatient&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//xor3surj More blood out time less than 4h out time less than 4h
...
check{all trans: Trans|//NAND constraint between Sample is not for the patient:Get Patient Info->Scan Sample and Samples have not been sent:Send Blood Order->Scan Sample
...
check{all trans: Trans|//surjective on (BloodOrder{quantity, expectTime}):Send Blood Order->Order Blood Product
all n:(NOrderBloodProduct&trans.target.nodes)| some e:(ABloodOrderquantityexpectTime&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//surjective on out time less then 0.5h:Collect Blood->Put Blood Into refrigertor
all n:(NPutBloodIntorefrigertor&trans.target.nodes)| some e:(Aouttimelessthen05h&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on ScanNurseCard min:0;max:2
let count = #NScanNurseCard&trans.target.nodes | count>=0 and count <=2
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//XOR constraint between out time less then 0.5h:Collect Blood->Put Blood Into refrigertor and out time less than 4h:Collect Blood->Scan Blood Product
...
check{all trans: Trans|//special out time less than 4h out time less than 4h
...
check{all trans: Trans|//XOR constraint between bloodtype is unknown or screening is not done or invalid(screen is valid within 4 days):Show Patient Info->Order Sample and :Show Patient Info->Order Blood
...
check{all trans: Trans|//imply2 Blood have not been ordered bloodtype is unknown or screening is not done or invalid(screen is valid within 4 days)
...
check{all trans: Trans|//surjective on (Blood*):Order Blood Product->Collect Blood
all n:(NCollectBlood&trans.target.nodes)| some e:(ABlood&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//XOR constraint between :Send Sample->Collect Blood and Blood have not been ordered:Send Sample->Order Blood
...
check{all trans: Trans|//surjective on :Order Blood->Select Blood Product
all n:(NSelectBloodProduct&trans.target.nodes)| some e:(ANOrderBloodNSelectBloodProduct&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//xorsurj bloodtype is unknown or screening is not done or invalid(screen is valid within 4 days) Samples have not been ordered
...
check{all trans: Trans|//xor3 Samples have not been sent Samples have not been ordered (BloodOrder{quantity, expectTime})
...
check{all trans: Trans|//xorsurj  The blood is for the patient
...
check{all trans: Trans|//imply2  Patient has not been bloodtyped
...
check{all trans: Trans|//imply2 out time less then 0.5h out time less than 4h
...
check{all trans: Trans|//xorsurj  Nurse is not found
...
check{all trans: Trans|//mulitplicity on Init min:1;max:1
let count = #NInit&trans.target.nodes | count>=1 and count <=1
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on ScanPatientWristband min:0;max:2
let count = #NScanPatientWristband&trans.target.nodes | count>=0 and count <=2
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//surjective on (Sample Label File*):Send Sample Order->Print Sample Label
all n:(NPrintSampleLabel&trans.target.nodes)| some e:(ASampleLabelFile&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//surjective on (Label*):Print Sample Label->Collect Sample
all n:(NCollectSample&trans.target.nodes)| some e:(ALabel&trans.target.arrows)| e.trg = n
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//mulitplicity on ScanSample min:0;max:1
let count = #NScanSample&trans.target.nodes | count>=0 and count <=1
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//XOR constraint between (Patient{temp, pressure_high, pressure_low, pulse}):Measure temperature, blood pressure and pulse->Store Patient Condition and :Measure temperature, blood pressure and pulse->perform transfusion
...
check{all trans: Trans|//mulitplicity on ScanBloodProduct min:0;max:2
let count = #NScanBloodProduct&trans.target.nodes | count>=0 and count <=2
}for 4 but exactly 1 Trans, exactly 2 Graph, exactly 1 Rule
check{all trans: Trans|//xor4  (Reaction{type})  More blood
...
check{all trans: Trans|//surjective on :perform transfusion->Measure temperature, blood pressure and pulse

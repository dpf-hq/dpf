...
public class BasicBorder extends AbstractBackground {
	 ...
	 * @since 3.5
	 */
	public BasicBorder(Color color, int width, int style) {
		setColor(color);
		setWidth(width);
		setStyle(style);
	}
	 ...
	 * @since 2.0
	 */
	public BasicBorder(Color color, int width) {
	 ...
	 * @since 2.0
	 */
	public BasicBorder(Color color) {
		this(color, 1);
	}

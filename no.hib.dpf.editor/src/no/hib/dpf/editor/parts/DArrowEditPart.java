 ...
 * </p>
 */
public class DArrowEditPart extends GraphicalConnectionEditPart implements
		NodeEditPart {
	...
	protected IFigure createFigure() {
		if (getArrowPaint() != null) {
			...
			connectionFigure.setTargetDecoration(arrowPaint
		...
		((ArrowConnection) connectionFigure).foreGroundColor = connectionFigure
				.getForegroundColor();
		for (Object edit : getChildren())
			if (edit instanceof AbstractGraphicalEditPart)
				connectionFigure.add(((AbstractGraphicalEditPart) edit)
						.getFigure());
	...
	public void refreshVisuals() {
		...
		if (getEditor() != null && connectionFigure instanceof ArrowConnection)
			((ArrowConnection) connectionFigure).setErrorFlag(getEditor()
					.isMakerExisting(darrow.getArrow()));
		refreshBendpoints();

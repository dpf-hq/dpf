...
public class ConstraintItemProvider
	...
	/**
	 * This adds a property descriptor for the Arrow Attributes feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addArrowAttributesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_arrowAttributes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_arrowAttributes_feature", "_UI_Constraint_type"),
				 CorePackage.Literals.CONSTRAINT__ARROW_ATTRIBUTES,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Node Attributes feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNodeAttributesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_nodeAttributes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_nodeAttributes_feature", "_UI_Constraint_type"),
				 CorePackage.Literals.CONSTRAINT__NODE_ATTRIBUTES,
				 true,
				 false,
				 true,
				 null,

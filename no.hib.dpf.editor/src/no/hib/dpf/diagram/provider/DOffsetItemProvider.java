...
/**
 * This is the item provider adapter for a {@link no.hib.dpf.diagram.DOffset} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DOffsetItemProvider
	 ...
	 * @generated
	 */
	public DOffsetItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DOffset_offset_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DOffset_offset_feature", "_UI_DOffset_type"),
				 DiagramPackage.Literals.DOFFSET__OFFSET,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Point labelValue = ((DOffset)object).getOffset();
		return labelValue == null ? null : labelValue.toString();
	}

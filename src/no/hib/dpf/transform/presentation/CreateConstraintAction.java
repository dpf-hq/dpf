...
public class CreateConstraintAction extends SelectionActionForEditParts {
	...
	private ProductionEditor editor = null;
	...
	public CreateConstraintAction(ProductionEditor part, DSpecification dSpecification, DPredicate predicate) {
		...
		editor = (ProductionEditor) getWorkbenchPart();
	}

...
\draw[arrows=->  ,shorten >=10pt,shorten <=10pt](9.684,-.287)--(4.842,-.144);
\draw[arrows=->  ,shorten >=10pt,shorten <=10pt](0,0)--(4.842,-.144);
\draw[arrows=->  ,shorten >=10pt,shorten <=10pt](8.301,-2.297)--(3.459,-2.153);
\draw[arrows=->  ,shorten >=10pt,shorten <=10pt](-1.383,-2.01)--(3.459,-2.153);
...
\draw[arrows=->  ,shorten >=10pt,shorten <=10pt](9.684,2.584)--(4.842,2.727);
\draw[arrows=->  ,shorten >=10pt,shorten <=10pt](0,2.871)--(4.842,2.727);
\draw[arrows=->  ,shorten >=10pt,shorten <=10pt](8.301,.574)--(3.459,.718);
\draw[arrows=->  ,shorten >=10pt,shorten <=10pt](-1.383,.861)--(3.459,.718);
...
\path (-1.383,-.574) node[left] {{\scriptsize$t_G$}}
               ...
               (3.459,-.718) node[left] {{\scriptsize$t_U$}} 
               (4.842,1.292) node[left] {{\scriptsize$t_I$}} 
...
\path (-.692,-1.005) node[left] {{\scriptsize$m$}}
                 (4.15,-1.148) node[left] {{\scriptsize$i$}} 
                 (8.992,-1.292) node[right] {{\scriptsize$m'$}};
...
\path (-.692,1.866) node[left] {{\scriptsize$tm$}}
                 (4.15,1.722) node[left] {{\scriptsize$ti$}} 

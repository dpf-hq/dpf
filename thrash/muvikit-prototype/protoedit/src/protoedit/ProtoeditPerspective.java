 ...
 * @author Tony Modica
 */
public class ProtoeditPerspective implements IPerspectiveFactory {
	...
	private void defineActions(final IPageLayout layout) {
		...
		layout.addNewWizardShortcut("protoedit.ui.wizards.MuvitorFileCreationWizard"); //$NON-NLS-1$
	...
	private void defineLayout(final IPageLayout layout) {
		...
		final IPlaceholderFolderLayout middleRight = layout
				.createPlaceholderFolder("middleRight", IPageLayout.TOP, 0.8f,
						"bottomRight");
		middleRight.addPlaceholder("protoedit.ui.graphs.GraphView" + ":*");
		/*

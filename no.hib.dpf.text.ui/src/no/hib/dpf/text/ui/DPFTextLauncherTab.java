...
import no.hib.dpf.text.DPFTextLauncher;
...
public class DPFTextLauncherTab extends AbstractLaunchConfigurationTab{
	...
	public void setDefaults(ILaunchConfigurationWorkingCopy configuration) {
		configuration.setAttribute(DPFTextLauncher.LAUNCH_FILE,"");
	}

	@Override
	public void performApply(ILaunchConfigurationWorkingCopy configuration) {
		configuration.setAttribute(DPFTextLauncher.LAUNCH_FILE,fileText.getText());
	}

	@Override
	public boolean isValid(ILaunchConfiguration launchConfig) {
		try {
			final Path path = new Path(launchConfig.getAttribute(DPFTextLauncher.LAUNCH_FILE,""));
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
	    try {
	    fileText.setText(configuration.getAttribute(DPFTextLauncher.LAUNCH_FILE, ""));
	   } catch(Exception ex) {
	    fileText.setText("");
	   }
	}
			...
			public void widgetSelected(SelectionEvent e) {
				...
				viewerFilters.add(new ViewerFilter() {					
					...
					private boolean isDPFFile(Object element){
						...
						return f.getName().endsWith(DPFTextLauncher.LAUNCH_FILE_ENDING);
					}
				});

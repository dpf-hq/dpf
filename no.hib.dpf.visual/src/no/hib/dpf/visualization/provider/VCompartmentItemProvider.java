...
public class VCompartmentItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCompartmentDNodePropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Compartment DNode feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCompartmentDNodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VCompartment_compartmentDNode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VCompartment_compartmentDNode_feature", "_UI_VCompartment_type"),
				 VisualizationPackage.Literals.VCOMPARTMENT__COMPARTMENT_DNODE,
				 true,
				 false,
				 true,
				 null,
		...
		newChildDescriptors.add
			(createChildParameter
				(VisualizationPackage.Literals.VCOMPARTMENT__CHILDREN,
				 VisualizationFactory.eINSTANCE.createVCompartmentElement()));
	}

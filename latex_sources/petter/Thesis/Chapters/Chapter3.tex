...
The figure presents different level of abstractions that the architecture
...
Model transformation environments such as Visual Automated Model
...
% \textbf{Body} has the three subcategories,
%1\textbf{variables}, \textbf{patterns} and \textbf{logic}.
...
% \begin{figure}[H]
%   \centering
%     \includegraphics[scale=0.9]{./Figures/doublePushout.png}
%     \rule{35em}{0.5pt}
%   \caption[Vertical and Horizontal model transformations]
%   {Vertical and horizontal model transformations.}
%   \label{fig:vertical_horizontal}
...
translated while graph N represents a negative application condition. Note that
a negative and positive application condition is similarly
represented but implemented differently. For example the double pushout
technique for graph transformations in figure~\ref{fig:DPO_NAC}.

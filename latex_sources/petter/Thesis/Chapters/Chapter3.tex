...
Model transformations are right there in the center of Model Driven Engineering.
...
How does a model transformation environment distinguish if a model
...
these models remain consistent. One could say that the target model does
implicit depend on the source model, since a model transformation requires a

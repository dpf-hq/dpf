...
meta-model. While the target of a model to text transformation are string
...
Every transformation rule has a meta-model attached. A meta-model is referred
to as a domain in Czarnecki and Helsen's survey\cite{Czarnecki2006}. This
is to make the term meta-model a more general term since some transformation
languages take other approaches to how these meta-models are created. The
...
the form of a meta-model expressed in MOF\cite{MOF}.

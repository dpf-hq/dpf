...
The very basic concept of model transformations is to perform changes to a
model.

A model transformation is when we change an instance of a source metamodel to an
instance that conforms to the target metamodel. We can distinguish these
operations into either endogenous or exogenous model transformations. In an

...
Figure~\ref{fig:workbench} shows the different components of a language
workbench.
...
provided in the article, \textit{``DPF Workbench: a multi-level language
workbench for MDE"}\cite{Lamo2013}, explains how the ``DPF Signature Editor'',

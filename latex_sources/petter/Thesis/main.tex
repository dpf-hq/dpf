...
ssads
%This master thesis describes a
%In this thesis we compare three model transformation languages:
%1) Henshin representing traditional graph transformation on Ecore models, 2)
%Attributed Graph Grammar (AGG) representing traditional graph transformation,
% and 3) Atlas Transformation Language (ATL) representing model transformation on Ecore
%models. Our case study is a fairly complicated refactoring of UML activity

...
\noindent In this article we have a specific example of a model transformation
and will evaluate how this  The task was to take a certain instance of model
transformation, in this case translating an activity diagram, written in the language UML and transform it to petri net. We initialize the metamodels to make sure that the

...
the source and the target model. These metamodels are created based the EMF
standard for creating models, that we talked about in section two. This approach
differ from the AGG approach we saw in section 3, where we have to create both
target and source metamodel in one common type graph. In Henshin the two
metamodels are independent of one and another, therefore they are included as
two separate models in the Henshin file. 

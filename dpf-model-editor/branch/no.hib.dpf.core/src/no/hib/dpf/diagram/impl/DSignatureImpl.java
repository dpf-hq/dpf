...
public class DSignatureImpl extends EObjectImpl implements DSignature {
	...
	/**
	 * The cached value of the '{@link #getDPredicates() <em>DPredicates</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDPredicates()
	 * @generated
	...
	public EList<DPredicate> getDPredicates() {
		if (dPredicates == null) {
			dPredicates = new EObjectResolvingEList<DPredicate>(DPredicate.class, this, DiagramPackage.DSIGNATURE__DPREDICATES);
		}
		return dPredicates;
	}

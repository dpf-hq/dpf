...
public class SpecificationType extends AbstractTypeImpl {
	...
	public Object newInstance() {
		System.out.println("SpecificationType#NEWINSTANCE");
		return null;
	}
	...
	public Feature[] getContributedFeatures() {
		...
		for(final EStructuralFeature ef : spec.eClass().getEStructuralFeatures()) {
			Type t = model.getTypeForETypedElement(ef); 
			System.out.println("----------->SpecificationType#getContributedFeatures Type resolve name: " + ef.getName());
			if(t == null) {
				System.out.println("----------->SpecificationType#getContributedFeatures Type resolve failed for: " + ef.getName());
			} else {
		...
		// Operations
		final EList<EOperation> eOperations = spec.eClass().getEOperations();
...
//		return new Feature[] {
//			new PropertyImpl(SpecificationType.this, "name", getTypeSystem().getStringType()) {
//				
//				@Override
//				public Object get(Object target) {
//					return new String("NAME: " + target.toString());
//				}
//			},
		res.add(new OperationImpl(SpecificationType.this, "toString", getTypeSystem().getStringType()) {

			@Override
			protected Object evaluateInternal(Object target, Object[] params) {
				if(target instanceof Specification) {
					return SpecificationType.toString((Specification)target);
				}
				return null;
			}
		});
//		};
	...
	protected static String toString(Specification s) {
		return "Operation in SpecificationType!!one1";
	}

...
import no.hib.dpf.codegen.xpand.metamodel.typesystem.StringHelper;
...
public class GraphType extends AbstractTypeImpl {
	...
	public Object newInstance() {
		System.out.println("GraphType#newInstance called");
		return null;
	}
	...
	public Feature[] getContributedFeatures() {
		...
		for(final EStructuralFeature ef : graph.eClass().getEStructuralFeatures()) {
			Type t = model.getTypeForETypedElement(ef); 
			System.out.println("----------->GraphType#getContributedFeatures Type resolve name: " + ef.getName());
			if(t == null) {
				System.out.println("----------->GraphType#getContributedFeatures Type resolve failed for: " + ef.getName());
			} else {
		...
		// Operations
		final EList<EOperation> eOperations = graph.eClass().getEOperations();
	...
	private void createGettersForDsmTypes(Set<FeatureImpl> res) {
		...
		for(final String name : nodetypes) {
			res.add(new OperationImpl(this, StringHelper.pluralize("get" + name), 

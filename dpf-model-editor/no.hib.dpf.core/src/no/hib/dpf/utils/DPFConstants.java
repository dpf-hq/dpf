...
public class DPFConstants {
	...
	public static final Node REFLEXIVE_TYPE_NODE = CoreFactory.eINSTANCE.createNode(NODE, null);
	public static final Arrow REFLEXIVE_TYPE_ARROW = CoreFactory.eINSTANCE.createArrow(ARROW, REFLEXIVE_TYPE_NODE, REFLEXIVE_TYPE_NODE, null);

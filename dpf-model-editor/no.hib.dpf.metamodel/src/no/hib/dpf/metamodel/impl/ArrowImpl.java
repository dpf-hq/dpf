...
public class ArrowImpl extends IDObjectImpl implements Arrow {
	...
	protected EClass eStaticClass() {
		return MetamodelPackage.Literals.ARROW;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MetamodelPackage.ARROW__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(Node newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.ARROW__TARGET, oldTarget, target));
	}
	...
	public Graph getGraph() {
		if (eContainerFeatureID() != MetamodelPackage.ARROW__GRAPH) return null;
	...
	public NotificationChain basicSetGraph(Graph newGraph, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newGraph, MetamodelPackage.ARROW__GRAPH, msgs);
		return msgs;
	}
	...
	public void setGraph(Graph newGraph) {
		if (newGraph != eInternalContainer() || (eContainerFeatureID() != MetamodelPackage.ARROW__GRAPH && newGraph != null)) {
			...
			if (newGraph != null)
				msgs = ((InternalEObject)newGraph).eInverseAdd(this, MetamodelPackage.GRAPH__ARROWS, Graph.class, msgs);
			msgs = basicSetGraph(newGraph, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.ARROW__GRAPH, newGraph, newGraph));
	}
	...
	public Node getSource() {
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MetamodelPackage.ARROW__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Node newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.ARROW__SOURCE, oldSource, source));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.ARROW__NAME, oldName, name));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case MetamodelPackage.ARROW__GRAPH:
				return eInternalContainer().eInverseRemove(this, MetamodelPackage.GRAPH__ARROWS, Graph.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MetamodelPackage.ARROW__TARGET:

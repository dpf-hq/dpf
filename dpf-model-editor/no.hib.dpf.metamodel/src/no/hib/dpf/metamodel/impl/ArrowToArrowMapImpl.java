 ...
 * <ul>
 *   <li>{@link no.hib.dpf.metamodel.impl.ArrowToArrowMapImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link no.hib.dpf.metamodel.impl.ArrowToArrowMapImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArrowToArrowMapImpl extends EObjectImpl implements BasicEMap.Entry<Arrow,Arrow> {
	...
	protected EClass eStaticClass() {
		return MetamodelPackage.Literals.ARROW_TO_ARROW_MAP;
	}
		...
		if (key != null && key.eIsProxy()) {
			...
			if (key != oldKey) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MetamodelPackage.ARROW_TO_ARROW_MAP__KEY, oldKey, key));
			}
		}
		return key;
	}
	...
	public void setTypedKey(Arrow newKey) {
		...
		key = newKey;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.ARROW_TO_ARROW_MAP__KEY, oldKey, key));
	}
	...
	public Arrow getTypedValue() {
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MetamodelPackage.ARROW_TO_ARROW_MAP__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setTypedValue(Arrow newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.ARROW_TO_ARROW_MAP__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MetamodelPackage.ARROW_TO_ARROW_MAP__KEY:
				if (resolve) return getTypedKey();
				return basicGetTypedKey();
			case MetamodelPackage.ARROW_TO_ARROW_MAP__VALUE:

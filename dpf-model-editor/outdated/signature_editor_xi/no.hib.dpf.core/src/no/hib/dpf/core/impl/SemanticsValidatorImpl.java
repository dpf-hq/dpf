...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Semantics Validator</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link no.hib.dpf.core.impl.SemanticsValidatorImpl#getType <em>Type</em>}</li>
 *   <li>{@link no.hib.dpf.core.impl.SemanticsValidatorImpl#getValidator <em>Validator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SemanticsValidatorImpl extends EObjectImpl implements SemanticsValidator {
	/**
	 ...
	 * @generated
	 */
	protected SemanticsValidatorImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.SEMANTICS_VALIDATOR;
	}
	...
	public void setType(ValidatorType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.SEMANTICS_VALIDATOR__TYPE, oldType, type));
	}
	...
	public void setValidator(String newValidator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.SEMANTICS_VALIDATOR__VALIDATOR, oldValidator, validator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.SEMANTICS_VALIDATOR__TYPE:
				return getType();
			case CorePackage.SEMANTICS_VALIDATOR__VALIDATOR:
				return getValidator();
		}

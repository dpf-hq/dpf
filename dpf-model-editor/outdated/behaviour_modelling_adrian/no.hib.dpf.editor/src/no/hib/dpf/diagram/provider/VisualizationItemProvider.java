...
/**
 * This is the item provider adapter for a {@link no.hib.dpf.diagram.Visualization} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DiagramPackage.Literals.VISUALIZATION__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Visualization_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Visualization_source_feature", "_UI_Visualization_type"),
				 DiagramPackage.Literals.VISUALIZATION__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Visualization_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Visualization_target_feature", "_UI_Visualization_type"),
				 DiagramPackage.Literals.VISUALIZATION__TARGET,
				 true,
				 false,
				 true,
				 null,

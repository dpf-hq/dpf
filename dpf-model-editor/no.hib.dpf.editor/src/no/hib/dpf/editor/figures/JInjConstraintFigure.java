...
public class JInjConstraintFigure extends PolylineConnection {

	Rectangle firstPointBounds;
	Rectangle lastPointBounds;
	BasicRectangleFigure basicRectangleFigure;
	
	public JInjConstraintFigure(BasicRectangleFigure basicRectangleFigure) {
	...
	protected void outlineShape(Graphics g) {
		...
		g.drawText("[Jointly Injective]", controlpoints[1].translate(-17, 0));

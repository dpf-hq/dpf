 ...
 *   <li>{@link no.hib.dpf.diagram.impl.DConstraintImpl#getDNodeDAttributes <em>DNode DAttributes</em>}</li>
 *   <li>{@link no.hib.dpf.diagram.impl.DConstraintImpl#getDArrowDAttributes <em>DArrow DAttributes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DConstraintImpl extends EObjectImpl implements DConstraint {
	...
	/**
	 * The cached value of the '{@link #getDNodeDAttributes() <em>DNode DAttributes</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getDArrowDAttributes() <em>DArrow DAttributes</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DiagramPackage.DCONSTRAINT__DNODE_DATTRIBUTES:
				return getDNodeDAttributes();
			case DiagramPackage.DCONSTRAINT__DARROW_DATTRIBUTES:
	...
	public EList<DNodeDAttribute> getDNodeDAttributes() {
		if (dNodeDAttributes == null) {
			dNodeDAttributes = new EObjectResolvingEList<DNodeDAttribute>(DNodeDAttribute.class, this, DiagramPackage.DCONSTRAINT__DNODE_DATTRIBUTES);
		}
	...
	public EList<DArrowDAttribute> getDArrowDAttributes() {
		if (dArrowDAttributes == null) {
			dArrowDAttributes = new EObjectResolvingEList<DArrowDAttribute>(DArrowDAttribute.class, this, DiagramPackage.DCONSTRAINT__DARROW_DATTRIBUTES);
		}

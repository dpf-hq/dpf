 ...
 * <em><b>DSpecification</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class DSpecificationImpl extends EObjectImpl implements DSpecification {
	...
	/**
	 * The cached value of the '{@link #getDConstraints() <em>DConstraints</em>}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDGraph(DGraph newDGraph,
	...
	public DSpecification getTemplateDSpecification() {
		try {
			...
			if(spec.eIsSet(CorePackage.Literals.SPECIFICATION__METALEVEL)){
				Assert.isNotNull(getDType());
				return getDType().getTemplateDSpecification();
			}else{
				return this; // default meta-level
			}
		} catch (Exception e) {}
		return null;
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case DiagramPackage.DSPECIFICATION__DTYPE:
			return dType != null
					&& dType != DPFDiagramConstants.REFLEXIVE_DSPECIFICATION;
		case DiagramPackage.DSPECIFICATION__DGRAPH:
			return dGraph != null;
		case DiagramPackage.DSPECIFICATION__DCONSTRAINTS:
		...
		case DiagramPackage.DSPECIFICATION__DSIGNATURE:
			return dSignature != null
					&& dSignature != DPFDiagramConstants.DEFAULT_DSIGNATURE;
		case DiagramPackage.DSPECIFICATION__META_FILE:
			return META_FILE_EDEFAULT == null ? metaFile != null
					: !META_FILE_EDEFAULT.equals(metaFile);
		case DiagramPackage.DSPECIFICATION__SIGNATURE_FILE:
			return SIGNATURE_FILE_EDEFAULT == null ? signatureFile != null
					: !SIGNATURE_FILE_EDEFAULT.equals(signatureFile);
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case DiagramPackage.DSPECIFICATION__DTYPE:
			setDType(DPFDiagramConstants.REFLEXIVE_DSPECIFICATION);
			return;
		case DiagramPackage.DSPECIFICATION__DGRAPH:
		...
		case DiagramPackage.DSPECIFICATION__GRID_VISIBLE:
			...
			return;
		case DiagramPackage.DSPECIFICATION__DSIGNATURE:
			setDSignature(DPFDiagramConstants.DEFAULT_DSIGNATURE);
			return;
		case DiagramPackage.DSPECIFICATION__META_FILE:
	...
	public void setDGraph(DGraph newDGraph) {
		if (newDGraph != dGraph) {
			...
			if (dGraph != null)
				msgs = ((InternalEObject) dGraph).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- DiagramPackage.DSPECIFICATION__DGRAPH, null,
						msgs);
			if (newDGraph != null)
				msgs = ((InternalEObject) newDGraph).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- DiagramPackage.DSPECIFICATION__DGRAPH, null,
						msgs);
			msgs = basicSetDGraph(newDGraph, msgs);
			if (specification != null && !specification.eIsProxy())
				specification.setGraph(dGraph != null ? dGraph.getGraph()
						: null);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiagramPackage.DSPECIFICATION__DGRAPH, newDGraph, newDGraph));
	}
	...
	public void setDSignature(DSignature newDSignature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiagramPackage.DSPECIFICATION__DSIGNATURE, oldDSignature,
					dSignature));
	}
	...
	public void setDType(DSpecification newDType) {
		...
		dType = newDType;
		if (getSpecification() != null)
			getSpecification().setType(
					getDType() == null ? null : getDType().getSpecification());
		if (getDGraph() != null)
			getDGraph().setDType(
					getDType() == null ? null : getDType().getDGraph());
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DiagramPackage.DSPECIFICATION__DTYPE, oldDType, dType));
	}
	...
	// resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put("dpf",
	// new XMLResourceFactoryImpl());
	// resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put("xmi",
	// new XMLResourceFactoryImpl());
	// Resource diagram = resourceSet.createResource(uri);
	// Resource model =
	// resourceSet.createResource(uri.appendFileExtension("xmi"));
	// Resource model_type =
	// resourceSet.createResource(uri.appendFileExtension("type").appendFileExtension("xmi"));
	// Resource diagram_type =
	// resourceSet.createResource(uri.appendFileExtension("xmi").appendFileExtension("type").appendFileExtension("xmi"));

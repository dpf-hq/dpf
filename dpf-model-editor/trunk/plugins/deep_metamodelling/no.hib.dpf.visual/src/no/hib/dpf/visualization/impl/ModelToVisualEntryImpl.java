 ...
 * @generated
 */
public class ModelToVisualEntryImpl extends EObjectImpl implements BasicEMap.Entry<DElement,VElement> {
	/**
	 ...
	 * @generated
	 */
	public DElement getTypedKey() {
		if (key != null && key.eIsProxy()) {
			InternalEObject oldKey = (InternalEObject)key;
			key = (DElement)eResolveProxy(oldKey);
			if (key != oldKey) {
	 ...
	 * @generated
	 */
	public DElement basicGetTypedKey() {
		return key;
	}
	 ...
	 * @generated
	 */
	public void setTypedKey(DElement newKey) {
		DElement oldKey = key;
		key = newKey;
		if (eNotificationRequired())
	 ...
	 */
	@Override
	public void setKey(DElement key) {
		setTypedKey(key);
	}
	...
	public EMap<DElement, VElement> getEMap() {

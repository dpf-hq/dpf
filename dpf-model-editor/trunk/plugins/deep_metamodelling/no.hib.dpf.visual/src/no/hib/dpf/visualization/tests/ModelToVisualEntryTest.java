...
public class ModelToVisualEntryTest extends TestCase {
	 ...
	 * @generated
	 */
	protected Map.Entry<DElement, VElement> fixture = null;
	 ...
	 * @generated
	 */
	protected void setFixture(Map.Entry<DElement, VElement> fixture) {
	 ...
	 * @generated
	 */
	protected Map.Entry<DElement, VElement> getFixture() {
		return fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture((Map.Entry<DElement, VElement>)VisualizationFactory.eINSTANCE.create(VisualizationPackage.Literals.MODEL_TO_VISUAL_ENTRY));
	}

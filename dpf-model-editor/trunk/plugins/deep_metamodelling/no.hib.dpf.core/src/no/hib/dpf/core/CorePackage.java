...
public interface CorePackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Metalevel</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SPECIFICATION__METALEVEL = 6;
	...
	/**
	 * The meta object id for the '{@link no.hib.dpf.core.MutableElement <em>Mutable Element</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see no.hib.dpf.core.MutableElement
	 * @see no.hib.dpf.core.impl.CorePackageImpl#getMutableElement()
	 * @generated
	 */
	int MUTABLE_ELEMENT = 15;
	 ...
	 * @ordered
	 */
	int GRAPH__POTENCY = ID_OBJECT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int GRAPH__TYPE = ID_OBJECT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int GRAPH__NODES = ID_OBJECT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int GRAPH__ARROWS = ID_OBJECT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int GRAPH__NAME = ID_OBJECT_FEATURE_COUNT + 4;

	/**
	 * The feature id for the '<em><b>Datanodes</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int GRAPH__DATANODES = ID_OBJECT_FEATURE_COUNT + 5;

	/**
	 * The feature id for the '<em><b>Arrow Attributes</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int GRAPH__ARROW_ATTRIBUTES = ID_OBJECT_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int GRAPH__NODE_ATTRIBUTES = ID_OBJECT_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int GRAPH_FEATURE_COUNT = ID_OBJECT_FEATURE_COUNT + 8;
	 ...
	 * @ordered
	 */
	int NODE__MUTABILITY = ID_OBJECT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int NODE__POTENCY = ID_OBJECT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int NODE__TYPE_NODE = ID_OBJECT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int NODE__NAME = ID_OBJECT_FEATURE_COUNT + 6;

	/**
	 * The feature id for the '<em><b>Outgoing Attributes</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int NODE__OUTGOING_ATTRIBUTES = ID_OBJECT_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int NODE_FEATURE_COUNT = ID_OBJECT_FEATURE_COUNT + 8;
	 ...
	 * @ordered
	 */
	int ARROW__MUTABILITY = ID_OBJECT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ARROW__POTENCY = ID_OBJECT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int ARROW__SOURCE = ID_OBJECT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int ARROW__TARGET = ID_OBJECT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int ARROW__TYPE_ARROW = ID_OBJECT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int ARROW__NAME = ID_OBJECT_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int ARROW__OUTGOING_ATTRIBUTES = ID_OBJECT_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int ARROW_FEATURE_COUNT = ID_OBJECT_FEATURE_COUNT + 8;
	...
	/**
	 * The feature id for the '<em><b>Arrow Attributes</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CONSTRAINT__ARROW_ATTRIBUTES = ID_OBJECT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int CONSTRAINT__NODE_ATTRIBUTES = ID_OBJECT_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int CONSTRAINT_FEATURE_COUNT = ID_OBJECT_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int MUTABLE_ELEMENT__MUTABILITY = 0;

	/**
	 * The number of structural features of the '<em>Mutable Element</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int MUTABLE_ELEMENT_FEATURE_COUNT = 1;

	/**
	 * The meta object id for the '{@link no.hib.dpf.core.impl.DataNodeImpl <em>Data Node</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see no.hib.dpf.core.impl.DataNodeImpl
	 * @see no.hib.dpf.core.impl.CorePackageImpl#getDataNode()
	 * @generated
	 */
	int DATA_NODE = 12;
	 ...
	 * @ordered
	 */
	int DATA_NODE__MUTABILITY = MUTABLE_ELEMENT__MUTABILITY;
	 ...
	 * @ordered
	 */
	int DATA_NODE__ID = MUTABLE_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int DATA_NODE__VALUE = MUTABLE_ELEMENT_FEATURE_COUNT + 1;

	/**
	 * The feature id for the '<em><b>Incoming Node Attributes</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int DATA_NODE__INCOMING_NODE_ATTRIBUTES = MUTABLE_ELEMENT_FEATURE_COUNT + 2;

	/**
	 * The feature id for the '<em><b>Incoming Arrow Atributes</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int DATA_NODE__INCOMING_ARROW_ATRIBUTES = MUTABLE_ELEMENT_FEATURE_COUNT + 3;

	/**
	 * The feature id for the '<em><b>Type Data Node</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int DATA_NODE__TYPE_DATA_NODE = MUTABLE_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int DATA_NODE__DATATYPE = MUTABLE_ELEMENT_FEATURE_COUNT + 5;

	/**
	 * The feature id for the '<em><b>Is Data Type</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int DATA_NODE__IS_DATA_TYPE = MUTABLE_ELEMENT_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int DATA_NODE_FEATURE_COUNT = MUTABLE_ELEMENT_FEATURE_COUNT + 7;

	/**
	 * The meta object id for the '{@link no.hib.dpf.core.impl.NodeAttributeImpl <em>Node Attribute</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see no.hib.dpf.core.impl.NodeAttributeImpl
	 * @see no.hib.dpf.core.impl.CorePackageImpl#getNodeAttribute()
	 * @generated
	 */
	int NODE_ATTRIBUTE = 13;
	 ...
	 * @ordered
	 */
	int NODE_ATTRIBUTE__ID = ID_OBJECT__ID;
	 ...
	 * @ordered
	 */
	int NODE_ATTRIBUTE__MUTABILITY = ID_OBJECT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int NODE_ATTRIBUTE__SOURCE = ID_OBJECT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int NODE_ATTRIBUTE__TYPE_ATTRIBUTE = ID_OBJECT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int NODE_ATTRIBUTE__CONSTRAINTS = ID_OBJECT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int NODE_ATTRIBUTE__TARGET = ID_OBJECT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int NODE_ATTRIBUTE__NAME = ID_OBJECT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int NODE_ATTRIBUTE_FEATURE_COUNT = ID_OBJECT_FEATURE_COUNT + 6;

	/**
	 * The meta object id for the '{@link no.hib.dpf.core.impl.ArrowAttributeImpl <em>Arrow Attribute</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see no.hib.dpf.core.impl.ArrowAttributeImpl
	 * @see no.hib.dpf.core.impl.CorePackageImpl#getArrowAttribute()
	 * @generated
	 */
	int ARROW_ATTRIBUTE = 14;
	 ...
	 * @ordered
	 */
	int ARROW_ATTRIBUTE__ID = ID_OBJECT__ID;
	 ...
	 * @ordered
	 */
	int ARROW_ATTRIBUTE__MUTABILITY = ID_OBJECT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ARROW_ATTRIBUTE__SOURCE = ID_OBJECT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int ARROW_ATTRIBUTE__TYPE_ATTRIBUTE = ID_OBJECT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int ARROW_ATTRIBUTE__CONSTRAINTS = ID_OBJECT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int ARROW_ATTRIBUTE__NAME = ID_OBJECT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int ARROW_ATTRIBUTE__TARGET = ID_OBJECT_FEATURE_COUNT + 5;

	/**
	 * The number of structural features of the '<em>Arrow Attribute</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ARROW_ATTRIBUTE_FEATURE_COUNT = ID_OBJECT_FEATURE_COUNT + 6;

	/**
	 * The meta object id for the '{@link no.hib.dpf.core.DeepElement <em>Deep Element</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see no.hib.dpf.core.DeepElement
	 * @see no.hib.dpf.core.impl.CorePackageImpl#getDeepElement()
	 * @generated
	 */
	int DEEP_ELEMENT = 16;
	 ...
	 * @ordered
	 */
	int DEEP_ELEMENT__POTENCY = 0;

	/**
	 * The number of structural features of the '<em>Deep Element</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int DEEP_ELEMENT_FEATURE_COUNT = 1;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link no.hib.dpf.core.Graph#getDatanodes <em>Datanodes</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Datanodes</em>'.
	 * @see no.hib.dpf.core.Graph#getDatanodes()
	 * @see #getGraph()
	 * @generated
	 */
	EReference getGraph_Datanodes();

	/**
	 * Returns the meta object for the containment reference list '{@link no.hib.dpf.core.Graph#getArrowAttributes <em>Arrow Attributes</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Arrow Attributes</em>'.
	 * @see no.hib.dpf.core.Graph#getArrowAttributes()
	 * @see #getGraph()
	 * @generated
	 */
	EReference getGraph_ArrowAttributes();

	/**
	 * Returns the meta object for the containment reference list '{@link no.hib.dpf.core.Graph#getNodeAttributes <em>Node Attributes</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Node Attributes</em>'.
	 * @see no.hib.dpf.core.Graph#getNodeAttributes()
	 * @see #getGraph()
	 * @generated
	 */
	EReference getGraph_NodeAttributes();
	...
	/**
	 * Returns the meta object for the reference list '{@link no.hib.dpf.core.Node#getOutgoingAttributes <em>Outgoing Attributes</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Outgoing Attributes</em>'.
	 * @see no.hib.dpf.core.Node#getOutgoingAttributes()
	 * @see #getNode()
	 * @generated
	 */
	EReference getNode_OutgoingAttributes();
	...
	/**
	 * Returns the meta object for the reference list '{@link no.hib.dpf.core.Arrow#getOutgoingAttributes <em>Outgoing Attributes</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Outgoing Attributes</em>'.
	 ...
	 * @generated
	 */
	EReference getArrow_OutgoingAttributes();
	...
	/**
	 * Returns the meta object for the reference list '{@link no.hib.dpf.core.Constraint#getArrowAttributes <em>Arrow Attributes</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Arrow Attributes</em>'.
	 * @see no.hib.dpf.core.Constraint#getArrowAttributes()
	 * @see #getConstraint()
	 * @generated
	 */
	EReference getConstraint_ArrowAttributes();

	/**
	 * Returns the meta object for the reference list '{@link no.hib.dpf.core.Constraint#getNodeAttributes <em>Node Attributes</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EReference getConstraint_NodeAttributes();
	...
	/**
	 * Returns the meta object for class '{@link no.hib.dpf.core.DataNode <em>Data Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Data Node</em>'.
	 * @see no.hib.dpf.core.DataNode
	 * @generated
	 */
	EClass getDataNode();

	/**
	 * Returns the meta object for the attribute '{@link no.hib.dpf.core.DataNode#getValue <em>Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Value</em>'.
	 * @see no.hib.dpf.core.DataNode#getValue()
	 * @see #getDataNode()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference list '{@link no.hib.dpf.core.DataNode#getIncomingNodeAttributes <em>Incoming Node Attributes</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Incoming Node Attributes</em>'.
	 * @see no.hib.dpf.core.DataNode#getIncomingNodeAttributes()
	 * @see #getDataNode()
	 * @generated
	 */
	EReference getDataNode_IncomingNodeAttributes();

	/**
	 * Returns the meta object for the reference list '{@link no.hib.dpf.core.DataNode#getIncomingArrowAtributes <em>Incoming Arrow Atributes</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Incoming Arrow Atributes</em>'.
	 * @see no.hib.dpf.core.DataNode#getIncomingArrowAtributes()
	 * @see #getDataNode()
	 * @generated
	 */
	EReference getDataNode_IncomingArrowAtributes();

	/**
	 * Returns the meta object for the reference '{@link no.hib.dpf.core.DataNode#getTypeDataNode <em>Type Data Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Type Data Node</em>'.
	 * @see no.hib.dpf.core.DataNode#getTypeDataNode()
	 * @see #getDataNode()
	 * @generated
	 */
	EReference getDataNode_TypeDataNode();

	/**
	 * Returns the meta object for the attribute '{@link no.hib.dpf.core.DataNode#getDatatype <em>Datatype</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Datatype</em>'.
	 * @see no.hib.dpf.core.DataNode#getDatatype()
	 * @see #getDataNode()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link no.hib.dpf.core.DataNode#isIsDataType <em>Is Data Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Is Data Type</em>'.
	 * @see no.hib.dpf.core.DataNode#isIsDataType()
	 * @see #getDataNode()
	 * @generated
	 */
	EAttribute getDataNode_IsDataType();

	/**
	 * Returns the meta object for class '{@link no.hib.dpf.core.NodeAttribute <em>Node Attribute</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Node Attribute</em>'.
	 * @see no.hib.dpf.core.NodeAttribute
	 * @generated
	 */
	EClass getNodeAttribute();

	/**
	 * Returns the meta object for the reference '{@link no.hib.dpf.core.NodeAttribute#getSource <em>Source</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Source</em>'.
	 ...
	 * @generated
	 */
	EReference getNodeAttribute_Source();

	/**
	 * Returns the meta object for the reference '{@link no.hib.dpf.core.NodeAttribute#getTypeAttribute <em>Type Attribute</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Type Attribute</em>'.
	 * @see no.hib.dpf.core.NodeAttribute#getTypeAttribute()
	 * @see #getNodeAttribute()
	 * @generated
	 */
	EReference getNodeAttribute_TypeAttribute();

	/**
	 * Returns the meta object for the reference list '{@link no.hib.dpf.core.NodeAttribute#getConstraints <em>Constraints</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Constraints</em>'.
	 * @see no.hib.dpf.core.NodeAttribute#getConstraints()
	 * @see #getNodeAttribute()
	 * @generated
	 */
	EReference getNodeAttribute_Constraints();

	/**
	 * Returns the meta object for the reference '{@link no.hib.dpf.core.NodeAttribute#getTarget <em>Target</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Target</em>'.
	 ...
	 * @generated
	 */
	EReference getNodeAttribute_Target();

	/**
	 * Returns the meta object for the attribute '{@link no.hib.dpf.core.NodeAttribute#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see no.hib.dpf.core.NodeAttribute#getName()
	 * @see #getNodeAttribute()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link no.hib.dpf.core.ArrowAttribute <em>Arrow Attribute</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Arrow Attribute</em>'.
	 * @see no.hib.dpf.core.ArrowAttribute
	 * @generated
	 */
	EClass getArrowAttribute();

	/**
	 * Returns the meta object for the reference '{@link no.hib.dpf.core.ArrowAttribute#getSource <em>Source</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Source</em>'.
	 * @see no.hib.dpf.core.ArrowAttribute#getSource()
	 * @see #getArrowAttribute()
	 * @generated
	 */
	EReference getArrowAttribute_Source();

	/**
	 * Returns the meta object for the reference '{@link no.hib.dpf.core.ArrowAttribute#getTypeAttribute <em>Type Attribute</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Type Attribute</em>'.
	 * @see no.hib.dpf.core.ArrowAttribute#getTypeAttribute()
	 * @see #getArrowAttribute()
	 * @generated
	 */
	EReference getArrowAttribute_TypeAttribute();

	/**
	 * Returns the meta object for the reference list '{@link no.hib.dpf.core.ArrowAttribute#getConstraints <em>Constraints</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Constraints</em>'.
	 * @see no.hib.dpf.core.ArrowAttribute#getConstraints()
	 * @see #getArrowAttribute()
	 * @generated
	 */
	EReference getArrowAttribute_Constraints();

	/**
	 * Returns the meta object for the attribute '{@link no.hib.dpf.core.ArrowAttribute#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see no.hib.dpf.core.ArrowAttribute#getName()
	 * @see #getArrowAttribute()
	 * @generated
	 */
	EAttribute getArrowAttribute_Name();

	/**
	 * Returns the meta object for the reference '{@link no.hib.dpf.core.ArrowAttribute#getTarget <em>Target</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Target</em>'.
	 ...
	 * @generated
	 */
	EReference getArrowAttribute_Target();

	/**
	 * Returns the meta object for class '{@link no.hib.dpf.core.MutableElement <em>Mutable Element</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Mutable Element</em>'.
	 * @see no.hib.dpf.core.MutableElement
	 * @generated
	 */
	EClass getMutableElement();

	/**
	 * Returns the meta object for the attribute '{@link no.hib.dpf.core.MutableElement#getMutability <em>Mutability</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Mutability</em>'.
	 * @see no.hib.dpf.core.MutableElement#getMutability()
	 * @see #getMutableElement()
	 * @generated
	 */
	EAttribute getMutableElement_Mutability();

	/**
	 * Returns the meta object for class '{@link no.hib.dpf.core.DeepElement <em>Deep Element</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Deep Element</em>'.
	 * @see no.hib.dpf.core.DeepElement
	 * @generated
	 */
	EClass getDeepElement();

	/**
	 * Returns the meta object for the attribute '{@link no.hib.dpf.core.DeepElement#getPotency <em>Potency</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Potency</em>'.
	 * @see no.hib.dpf.core.DeepElement#getPotency()
	 * @see #getDeepElement()
	 * @generated
	 */
	EAttribute getDeepElement_Potency();
	...
	/**
	 * Returns the meta object for the attribute '{@link no.hib.dpf.core.Specification#getMetalevel <em>Metalevel</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Metalevel</em>'.
	 * @see no.hib.dpf.core.Specification#getMetalevel()
	 * @see #getSpecification()
	 * @generated
	 */
	EAttribute getSpecification_Metalevel();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Datanodes</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference GRAPH__DATANODES = eINSTANCE.getGraph_Datanodes();

		/**
		 * The meta object literal for the '<em><b>Arrow Attributes</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference GRAPH__ARROW_ATTRIBUTES = eINSTANCE.getGraph_ArrowAttributes();
		 ...
		 * @generated
		 */
		EReference GRAPH__NODE_ATTRIBUTES = eINSTANCE.getGraph_NodeAttributes();
		...
		/**
		 * The meta object literal for the '<em><b>Outgoing Attributes</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference NODE__OUTGOING_ATTRIBUTES = eINSTANCE.getNode_OutgoingAttributes();
		 ...
		 * @generated
		 */
		EReference ARROW__OUTGOING_ATTRIBUTES = eINSTANCE.getArrow_OutgoingAttributes();
		...
		/**
		 * The meta object literal for the '<em><b>Arrow Attributes</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference CONSTRAINT__ARROW_ATTRIBUTES = eINSTANCE.getConstraint_ArrowAttributes();
		 ...
		 * @generated
		 */
		EReference CONSTRAINT__NODE_ATTRIBUTES = eINSTANCE.getConstraint_NodeAttributes();
		...
		/**
		 * The meta object literal for the '{@link no.hib.dpf.core.impl.DataNodeImpl <em>Data Node</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see no.hib.dpf.core.impl.DataNodeImpl
		 * @see no.hib.dpf.core.impl.CorePackageImpl#getDataNode()
		...
		/**
		 * The meta object literal for the '<em><b>Incoming Node Attributes</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference DATA_NODE__INCOMING_NODE_ATTRIBUTES = eINSTANCE.getDataNode_IncomingNodeAttributes();

		/**
		 * The meta object literal for the '<em><b>Incoming Arrow Atributes</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference DATA_NODE__INCOMING_ARROW_ATRIBUTES = eINSTANCE.getDataNode_IncomingArrowAtributes();

		/**
		 * The meta object literal for the '<em><b>Type Data Node</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference DATA_NODE__TYPE_DATA_NODE = eINSTANCE.getDataNode_TypeDataNode();
		 ...
		 * @generated
		 */
		EAttribute DATA_NODE__DATATYPE = eINSTANCE.getDataNode_Datatype();

		/**
		 * The meta object literal for the '<em><b>Is Data Type</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute DATA_NODE__IS_DATA_TYPE = eINSTANCE.getDataNode_IsDataType();

		/**
		 * The meta object literal for the '{@link no.hib.dpf.core.impl.NodeAttributeImpl <em>Node Attribute</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see no.hib.dpf.core.impl.NodeAttributeImpl
		 * @see no.hib.dpf.core.impl.CorePackageImpl#getNodeAttribute()
		 ...
		 * @generated
		 */
		EReference NODE_ATTRIBUTE__SOURCE = eINSTANCE.getNodeAttribute_Source();
		 ...
		 * @generated
		 */
		EReference NODE_ATTRIBUTE__TYPE_ATTRIBUTE = eINSTANCE.getNodeAttribute_TypeAttribute();
		 ...
		 * @generated
		 */
		EReference NODE_ATTRIBUTE__CONSTRAINTS = eINSTANCE.getNodeAttribute_Constraints();
		 ...
		 * @generated
		 */
		EReference NODE_ATTRIBUTE__TARGET = eINSTANCE.getNodeAttribute_Target();
		...
		/**
		 * The meta object literal for the '{@link no.hib.dpf.core.impl.ArrowAttributeImpl <em>Arrow Attribute</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see no.hib.dpf.core.impl.ArrowAttributeImpl
		 * @see no.hib.dpf.core.impl.CorePackageImpl#getArrowAttribute()
		 * @generated
		 */
		EClass ARROW_ATTRIBUTE = eINSTANCE.getArrowAttribute();
		 ...
		 * @generated
		 */
		EReference ARROW_ATTRIBUTE__SOURCE = eINSTANCE.getArrowAttribute_Source();
		 ...
		 * @generated
		 */
		EReference ARROW_ATTRIBUTE__TYPE_ATTRIBUTE = eINSTANCE.getArrowAttribute_TypeAttribute();
		 ...
		 * @generated
		 */
		EReference ARROW_ATTRIBUTE__CONSTRAINTS = eINSTANCE.getArrowAttribute_Constraints();
		 ...
		 * @generated
		 */
		EAttribute ARROW_ATTRIBUTE__NAME = eINSTANCE.getArrowAttribute_Name();
		 ...
		 * @generated
		 */
		EReference ARROW_ATTRIBUTE__TARGET = eINSTANCE.getArrowAttribute_Target();

		/**
		 * The meta object literal for the '{@link no.hib.dpf.core.MutableElement <em>Mutable Element</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see no.hib.dpf.core.MutableElement
		 * @see no.hib.dpf.core.impl.CorePackageImpl#getMutableElement()
		 * @generated
		 */
		EClass MUTABLE_ELEMENT = eINSTANCE.getMutableElement();
		 ...
		 * @generated
		 */
		EAttribute MUTABLE_ELEMENT__MUTABILITY = eINSTANCE.getMutableElement_Mutability();

		/**
		 * The meta object literal for the '{@link no.hib.dpf.core.DeepElement <em>Deep Element</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see no.hib.dpf.core.DeepElement
		 * @see no.hib.dpf.core.impl.CorePackageImpl#getDeepElement()
		 * @generated
		 */
		EClass DEEP_ELEMENT = eINSTANCE.getDeepElement();
		 ...
		 * @generated
		 */
		EAttribute DEEP_ELEMENT__POTENCY = eINSTANCE.getDeepElement_Potency();
		...
		/**
		 * The meta object literal for the '<em><b>Metalevel</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute SPECIFICATION__METALEVEL = eINSTANCE.getSpecification_Metalevel();

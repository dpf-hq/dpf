 ...
 *   <li>{@link no.hib.dpf.core.Graph#getDatanodes <em>Datanodes</em>}</li>
 *   <li>{@link no.hib.dpf.core.Graph#getArrowAttributes <em>Arrow Attributes</em>}</li>
 *   <li>{@link no.hib.dpf.core.Graph#getNodeAttributes <em>Node Attributes</em>}</li>
 * </ul>
 * </p>
 *
 ...
 * @generated
 */
public interface Graph extends IDObject, DeepElement {
	...
	/**
	 * Returns the value of the '<em><b>Datanodes</b></em>' containment reference list.
	 * The list contents are of type {@link no.hib.dpf.core.DataNode}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Datanodes</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Datanodes</em>' containment reference list.
	 * @see no.hib.dpf.core.CorePackage#getGraph_Datanodes()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Arrow Attributes</b></em>' containment reference list.
	 * The list contents are of type {@link no.hib.dpf.core.ArrowAttribute}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Arrow Attributes</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Arrow Attributes</em>' containment reference list.
	 * @see no.hib.dpf.core.CorePackage#getGraph_ArrowAttributes()
	 * @model containment="true"
	 * @generated
	 */
	EList<ArrowAttribute> getArrowAttributes();
	 ...
	 * @see no.hib.dpf.core.CorePackage#getGraph_NodeAttributes()
	 * @model containment="true"
	 * @generated
	 */
	EList<NodeAttribute> getNodeAttributes();
	...
	void addNodeAttribute(NodeAttribute nodeAttribute);
	void addArrowAttribute(ArrowAttribute arrowAttribute);
	void addNode(Node node);
	void addArrow(Arrow arrow);
	void removeNode(Node node);
	void removeArrow(Arrow arrow);

	NodeAttribute getNodeAttributeByName(String defaultNodeAttributeName);

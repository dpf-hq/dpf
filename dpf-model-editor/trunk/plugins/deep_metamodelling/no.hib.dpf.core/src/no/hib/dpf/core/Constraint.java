 ...
 *   <li>{@link no.hib.dpf.core.Constraint#getArrowAttributes <em>Arrow Attributes</em>}</li>
 *   <li>{@link no.hib.dpf.core.Constraint#getNodeAttributes <em>Node Attributes</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Constraint extends IDObject {
	...
	/**
	 * Returns the value of the '<em><b>Arrow Attributes</b></em>' reference list.
	 * The list contents are of type {@link no.hib.dpf.core.ArrowAttribute}.
	 * It is bidirectional and its opposite is '{@link no.hib.dpf.core.ArrowAttribute#getConstraints <em>Constraints</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Arrow Attributes</em>' reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Arrow Attributes</em>' reference list.
	 * @see no.hib.dpf.core.CorePackage#getConstraint_ArrowAttributes()
	 ...
	 * It is bidirectional and its opposite is '{@link no.hib.dpf.core.NodeAttribute#getConstraints <em>Constraints</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see no.hib.dpf.core.CorePackage#getConstraint_NodeAttributes()

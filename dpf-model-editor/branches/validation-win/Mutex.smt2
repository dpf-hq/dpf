...
(declare-fun delEID (V-INNV-INNE-INN RuleID) Bool)
(declare-fun addEID (V-OUTV-OUTE-OUT RuleID) Bool)
...
(assert (! (forall ((a V-INN) (id RuleID)) (=> (and (NNullVI a) (exists ((b V-OUT)) (and (VO b) (= (delV a) b)))) (delVID a id))) :named del-node-id-true))
(assert (! (forall ((a V-OUT) (id RuleID)) (=> (and (NNullVO a) (exists ((b V-INN)) (and (VI b) (= (addV a) b)))) (addVID a id))) :named add-node-id-true))
(assert (! (forall ((a V-INN) (b V-INN) (c E-INN) (id RuleID)) (=> (and (NNullEI a b c) (exists ((d V-OUT) (e V-OUT) (f E-OUT)) (and (NEO d e f) (= (delE a b c) (out-tuple d e f))))) (delEID a b c id))) :named del-edge-id-true))
(assert (! (forall ((a V-OUT) (b V-OUT) (c E-OUT) (id RuleID)) (=> (and (NNullEO a b c) (exists ((d V-INN) (e V-INN) (f E-INN)) (and (NEI d e f) (= (addE a b c) (inn-tuple d e f))))) (addEID a b c id))) :named add-edge-id-true))
...
(assert (! (forall ((a V-INN) (id RuleID)) (=> (delVID a id))) (and (NNullVI a) (exists ((b V-OUT)) (and (VO b) (= (delV a) b)))) :named del-node-id-true-domain))
(assert (! (forall ((a V-OUT) (id RuleID)) (=> (addVID a id))) (and (NNullVO a) (exists ((b V-INN)) (and (VI b) (= (addV a) b)))) :named add-node-id-true-domain))
(assert (! (forall ((a V-INN) (b V-INN) (c E-INN) (id RuleID)) (=> (delEID a b c id))) (and (NNullEI a b c) (exists ((d V-OUT) (e V-OUT) (f E-OUT)) (and (NEO d e f) (= (delE a b c) (out-tuple d e f))))) :named del-edge-id-true-domain))
(assert (! (forall ((a V-OUT) (b V-OUT) (c E-OUT) (id RuleID)) (=> (addEID a b c id))) (and (NNullEO a b c) (exists ((d V-INN) (e V-INN) (f E-INN)) (and (NEI d e f) (= (addE a b c) (inn-tuple d e f))))) :named add-edge-id-true-domain))
(assert (! (forall ((a V-INN) (b V-INN) (c E-INN) (id RuleID)) (=> (and (delVID a id)) (=> (and (=> (NNullEI a b c) (delEID a b c id)) (=> (NNullEI b a c) (delEID b a c id)))))) :named id-node-del-edge-del))
(assert (! (forall ((a V-OUT) (b V-OUT) (c E-OUT) (id RuleID)) (=> (and (addVID a id)) (=> (and (=> (NNullEO a b c) (addEID a b c id)) (=> (NNullEO b a c) (addEID b a c id)))))) :named id-node-add-edge-add))

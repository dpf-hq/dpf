...
(assert (! (forall ((a V-INN) (b V-OUT) (t V-INN) (e E-INN)) (=> (and (= (delV a) b) (ValidVI a)) (and (=> (ValidEI a t e) (exists ((t1 V-OUT) (e1 E-OUT)) (= (delE a t e) (out-tuple b t1 e1)))) (=> (ValidEI t a e) (exists ((t1 V-OUT) (e1 E-OUT)) (= (delE t a e) (out-tuple t1 b e1))))))) :named del-node-edge-deleted))
(assert (! (forall ((a V-OUT) (b V-INN) (t V-OUT) (e E-OUT)) (=> (and (= (addV a) b) (ValidVO a)) (and (=> (ValidEO a t e) (exists ((t1 V-INN) (e1 E-INN)) (= (addE a t e) (inn-tuple b t1 e1)))) (=> (ValidEO t a e) (exists ((t1 V-INN) (e1 E-INN)) (= (addE t a e) (inn-tuple t1 b e1))))))) :named add-node-edge-deleted))
...
(assert (! (forall ((a V-INN) (b V-OUT)) (=> (and (or (not (ValidVI a)) (VI a)) (= (delV a) b)) (VO b))) :named Null-Inn-Or-Unvalid-Node-Null-Out-Deled))
(assert (! (forall ((a V-OUT) (b V-INN)) (=> (and (or (not (ValidVO a)) (VO a)) (= (addV a) b)) (VI b))) :named Null-Out-Or-Unvalid-Node-Null-Inn-Added))
(assert (! (forall ((a V-INN) (b V-INN) (c E-INN) (d V-OUT) (e V-OUT) (f E-OUT)) (=> (and (or (not (ValidEI a b c)) (NEI a b c)) (= (delE a b c) (out-tuple d e f))) (NEO d e f))) :named Null-Inn-Or-Unvalid-Edge--Null-Out-Edge-Deled))
(assert (! (forall ((a V-OUT) (b V-OUT) (c E-OUT) (d V-INN) (e V-INN) (f E-INN)) (=> (and (or (not (ValidEO a b c)) (NEO a b c)) (= (addE a b c) (inn-tuple d e f))) (NEI d e f))) :named Null-Out-Or-Unvalid-Edge--Null-Inn-Edge-Added))
...
(assert (! (forall ((a V-INN) (b V-INN) (c E-INN) (d V-OUT) (e V-OUT) (f E-OUT) (h V-OUT) (i V-OUT) (j E-OUT)) (=> (and (and (NNullEO d e f) (NNullEO h i j)) (and (= (addE d e f) (inn-tuple a b c)) (NNullEI a b c))) (or (or (= d h) (or (= e i) (= f j))) (not (= (addE h i j) (inn-tuple a b c)))))) :named add-edge-injective))
(assert (! (forall ((a V-INN) (b V-INN) (c E-INN) (d V-OUT) (e V-OUT) (f E-OUT) (h V-INN) (i V-INN) (j E-INN)) (=> (and (and (NNullEI a b c) (NNullEI h i j)) (and (= (delE a b c) (out-tuple d e f)) (NNullEO d e f))) (or (or (= a h) (or (= b i) (= c j))) (not (= (delE h i j) (out-tuple d e f)))))) :named del-edge-injective))
(assert (! (forall ((a V-INN)) (=> (ValidVI a) (exists ((b V-OUT)) (and (ValidVO b) (= a (addV b)))))) :named node-add-surjective))
(assert (! (forall ((a V-OUT)) (=> (ValidVO a) (exists ((b V-INN)) (and (ValidVI b) (= a (delV b)))))) :named node-del-surjective))
(assert (! (forall ((a V-INN) (b V-INN) (c E-INN)) (=> (ValidEI a b c) (exists ((d V-OUT) (e V-OUT) (f E-OUT)) (and (ValidEO d e f) (= (addE d e f) (inn-tuple a b c)))))) :named edge-add-surjective))
(assert (! (forall ((a V-OUT) (b V-OUT) (c E-OUT)) (=> (ValidEO a b c) (exists ((d V-INN) (e V-INN) (f E-INN)) (and (ValidEI d e f) (= (delE d e f) (out-tuple a b c)))))) :named edge-del-surjective))
...
(assert (! (forall ((a V-INN)) (=> (ValidVI a) (exists ((b V-OUT)) (and (ValidVO b) (= b (delV a)))))) :named every-node-in-source-is-deled))
(assert (! (forall ((a V-OUT)) (=> (ValidVO a) (exists ((b V-INN)) (and (ValidVI b) (= b (addV a)))))) :named every-node-in-target-is-added))
(assert (! (forall ((a V-INN) (b V-INN) (c E-INN)) (=> (ValidEI a b c) (exists ((d V-OUT) (e V-OUT) (f E-OUT)) (and (ValidEO d e f) (= (delE a b c) (out-tuple d e f)))))) :named every-edge-in-source-is-deled))
(assert (! (forall ((a V-OUT) (b V-OUT) (c E-OUT)) (=> (ValidEO a b c) (exists ((d V-INN) (e V-INN) (f E-INN)) (and (ValidEI d e f) (= (addE a b c) (inn-tuple d e f)))))) :named every-edge-in-target-is-added))

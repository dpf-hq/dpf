...
/**
 * This is the item provider adapter for a {@link no.hib.dpf.visual.VArrow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VArrowItemProvider
	 ...
	 * @generated
	 */
	public VArrowItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VArrow"));
	}
	...
	public String getText(Object object) {
		String label = ((VArrow)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_VArrow_type") :
			getString("_UI_VArrow_type") + " " + label;
	}

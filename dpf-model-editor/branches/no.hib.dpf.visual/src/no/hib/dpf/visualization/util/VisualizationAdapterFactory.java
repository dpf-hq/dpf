...
public class VisualizationAdapterFactory extends AdapterFactoryImpl {
	...
	protected VisualizationSwitch<Adapter> modelSwitch =
		new VisualizationSwitch<Adapter>() {
			@Override
			public Adapter caseVisualizations(Visualizations object) {
				return createVisualizationsAdapter();
			}
			@Override
			public Adapter caseModelToVisualEntry(Map.Entry<IDObject, VElement> object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link no.hib.dpf.visualization.Visualizations <em>Visualizations</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createVisualizationsAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link java.util.Map.Entry <em>Model To Visual Entry</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

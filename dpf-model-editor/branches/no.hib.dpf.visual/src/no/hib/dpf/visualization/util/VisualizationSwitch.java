...
public class VisualizationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case VisualizationPackage.MODEL_TO_VISUAL_ENTRY: {
				@SuppressWarnings("unchecked") Map.Entry<IDObject, VElement> modelToVisualEntry = (Map.Entry<IDObject, VElement>)theEObject;
	 ...
	 * @generated
	 */
	public T caseModelToVisualEntry(Map.Entry<IDObject, VElement> object) {
		return null;
	}

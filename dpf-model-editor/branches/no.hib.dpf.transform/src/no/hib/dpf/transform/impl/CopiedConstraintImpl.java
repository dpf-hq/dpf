...
import no.hib.dpf.core.impl.ConstraintImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Copied Constraint</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link no.hib.dpf.transform.impl.CopiedConstraintImpl#getCopiedType <em>Copied Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CopiedConstraintImpl extends ConstraintImpl implements CopiedConstraint {
	/**
	 ...
	 * @generated
	 */
	protected CopiedConstraintImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TransformPackage.Literals.COPIED_CONSTRAINT;
	}
	...
	public void setCopiedType(CopiedType newCopiedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TransformPackage.COPIED_CONSTRAINT__COPIED_TYPE, oldCopiedType, copiedType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TransformPackage.COPIED_CONSTRAINT__COPIED_TYPE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Copied.class) {
			switch (derivedFeatureID) {
				case TransformPackage.COPIED_CONSTRAINT__COPIED_TYPE: return TransformPackage.COPIED__COPIED_TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Copied.class) {
			switch (baseFeatureID) {
				case TransformPackage.COPIED__COPIED_TYPE: return TransformPackage.COPIED_CONSTRAINT__COPIED_TYPE;
				default: return -1;
			}
		}

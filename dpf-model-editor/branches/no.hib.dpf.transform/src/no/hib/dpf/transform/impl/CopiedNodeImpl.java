...
import no.hib.dpf.core.impl.NodeImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Copied Node</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link no.hib.dpf.transform.impl.CopiedNodeImpl#getCopiedType <em>Copied Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CopiedNodeImpl extends NodeImpl implements CopiedNode {
	/**
	...
	protected EClass eStaticClass() {
		return TransformPackage.Literals.COPIED_NODE;
	}
	...
	public void setCopiedType(CopiedType newCopiedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TransformPackage.COPIED_NODE__COPIED_TYPE, oldCopiedType, copiedType));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Copied.class) {
			switch (derivedFeatureID) {
				case TransformPackage.COPIED_NODE__COPIED_TYPE: return TransformPackage.COPIED__COPIED_TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Copied.class) {
			switch (baseFeatureID) {
				case TransformPackage.COPIED__COPIED_TYPE: return TransformPackage.COPIED_NODE__COPIED_TYPE;
				default: return -1;
			}
		}

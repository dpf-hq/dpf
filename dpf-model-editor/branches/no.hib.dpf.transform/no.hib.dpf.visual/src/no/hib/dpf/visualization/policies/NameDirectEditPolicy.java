...
import no.hib.dpf.visualization.presentation.VCompartmentElementEditPart;
...
public class NameDirectEditPolicy extends DirectEditPolicy {
	...
	protected Command getDirectEditCommand(DirectEditRequest request) {
		...
		if(getHost() instanceof VCompartmentElementEditPart){
			...
			if(!compElement.getDNode().getName().equals(name))
			return new ChangeNameCommand(compElement.getDNode(), name);
		}
		return null;
	}

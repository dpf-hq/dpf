...
public interface TdpfPackage extends EPackage
{
   ...
   * @ordered
   */
  int SPECIFICATION__CONSTRAINT_SEMANTIC = MODEL_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int SPECIFICATION__SEQUENCE_NUMBER = MODEL_FEATURE_COUNT + 2;
  ...
  /**
   * The meta object id for the '{@link no.hib.dpf.text.tdpf.impl.SequenceNumberImpl <em>Sequence Number</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see no.hib.dpf.text.tdpf.impl.SequenceNumberImpl
   * @see no.hib.dpf.text.tdpf.impl.TdpfPackageImpl#getSequenceNumber()
   * @generated
   */
   ...
   * @ordered
   */
  int SEQUENCE_NUMBER__NEXT_NUMBER = 0;

  /**
   * The number of structural features of the '<em>Sequence Number</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int SEQUENCE_NUMBER_FEATURE_COUNT = 1;
   ...
   * @generated
   */
  int CHOOSEN_CONSTRAINT_SEMANTIC = 12;
   ...
   * @ordered
   */
  int SIGNATURE__COMMANDS = MODEL__COMMANDS;
   ...
   * @ordered
   */
  int SIGNATURE__CONSTRAINT_SEMANTICS = MODEL_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int SIGNATURE_FEATURE_COUNT = MODEL_FEATURE_COUNT + 1;
  ...
  /**
   * Returns the meta object for the containment reference '{@link no.hib.dpf.text.tdpf.Specification#getConstraintSemantic <em>Constraint Semantic</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Constraint Semantic</em>'.
   * @see no.hib.dpf.text.tdpf.Specification#getConstraintSemantic()
   * @see #getSpecification()
   * @generated
   */
  EReference getSpecification_ConstraintSemantic();

  /**
   * Returns the meta object for the containment reference '{@link no.hib.dpf.text.tdpf.Specification#getSequenceNumber <em>Sequence Number</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  EReference getSpecification_SequenceNumber();
  ...
  /**
   * Returns the meta object for class '{@link no.hib.dpf.text.tdpf.SequenceNumber <em>Sequence Number</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Sequence Number</em>'.
   * @see no.hib.dpf.text.tdpf.SequenceNumber
   * @generated
   */
  EClass getSequenceNumber();

  /**
   * Returns the meta object for the attribute '{@link no.hib.dpf.text.tdpf.SequenceNumber#getNextNumber <em>Next Number</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Next Number</em>'.
   * @see no.hib.dpf.text.tdpf.SequenceNumber#getNextNumber()
   * @see #getSequenceNumber()
   * @generated
   */
  EAttribute getSequenceNumber_NextNumber();
  ...
  /**
   * Returns the meta object for the containment reference list '{@link no.hib.dpf.text.tdpf.Signature#getConstraintSemantics <em>Constraint Semantics</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Constraint Semantics</em>'.
   * @see no.hib.dpf.text.tdpf.Signature#getConstraintSemantics()
   * @see #getSignature()
   * @generated
   */
  EReference getSignature_ConstraintSemantics();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference SPECIFICATION__CONSTRAINT_SEMANTIC = eINSTANCE.getSpecification_ConstraintSemantic();
     ...
     * @generated
     */
    EReference SPECIFICATION__SEQUENCE_NUMBER = eINSTANCE.getSpecification_SequenceNumber();
    ...
    /**
     * The meta object literal for the '{@link no.hib.dpf.text.tdpf.impl.SequenceNumberImpl <em>Sequence Number</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see no.hib.dpf.text.tdpf.impl.SequenceNumberImpl
     * @see no.hib.dpf.text.tdpf.impl.TdpfPackageImpl#getSequenceNumber()
     * @generated
     */
    EClass SEQUENCE_NUMBER = eINSTANCE.getSequenceNumber();
     ...
     * @generated
     */
    EAttribute SEQUENCE_NUMBER__NEXT_NUMBER = eINSTANCE.getSequenceNumber_NextNumber();
     ...
     * @generated
     */
    EReference SIGNATURE__CONSTRAINT_SEMANTICS = eINSTANCE.getSignature_ConstraintSemantics();

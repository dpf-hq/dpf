...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Evo Span</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link no.hib.dpf.text.tdpf.impl.EvoSpanImpl#getLhs <em>Lhs</em>}</li>
 *   <li>{@link no.hib.dpf.text.tdpf.impl.EvoSpanImpl#getRhs <em>Rhs</em>}</li>
 *   <li>{@link no.hib.dpf.text.tdpf.impl.EvoSpanImpl#getTypeGraph <em>Type Graph</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EvoSpanImpl extends DefinitionImpl implements EvoSpan
{
  ...
  {
    return TdpfPackage.Literals.EVO_SPAN;
  }
  ...
  public void setLhs(String newLhs)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TdpfPackage.EVO_SPAN__LHS, oldLhs, lhs));
  }
  ...
  public void setRhs(String newRhs)
  {
    ...
    rhs = newRhs;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TdpfPackage.EVO_SPAN__RHS, oldRhs, rhs));
  }
  ...
  public void setTypeGraph(String newTypeGraph)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TdpfPackage.EVO_SPAN__TYPE_GRAPH, oldTypeGraph, typeGraph));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TdpfPackage.EVO_SPAN__LHS:
        return getLhs();
      case TdpfPackage.EVO_SPAN__RHS:
        return getRhs();
      case TdpfPackage.EVO_SPAN__TYPE_GRAPH:
        return getTypeGraph();
    }

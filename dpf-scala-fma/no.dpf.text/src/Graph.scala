...
case class Node(override val id:Id, override implicit val t:TypeNode) extends Element with TypeNode{
	override def equals(o: Any) = o match { 
		case n:Node => n.id == id 
		case _ => false 
	} 
}
case class Arrow(override val id:Id, sr:Node, tg:Node, override implicit val t:TypeArrow) extends Element with TypeArrow{
	override def equals(o: Any) = o match { 

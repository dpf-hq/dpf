...
(
    ...
    { 
        $current = $this_SimpleEvoSpan_4.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_SimpleEvoCospan_5.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_Morphism_6.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_EvoSpan_7.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_EvoCospan_8.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleSequenceNumber returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getSequenceNumberRule()); }
	 iv_ruleSequenceNumber=ruleSequenceNumber 
	 { $current=$iv_ruleSequenceNumber.current; } 
	 EOF 
;

// Rule SequenceNumber
ruleSequenceNumber returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
(
		lv_nextNumber_0_0=RULE_INT
		{

...
public class TdpfAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected TdpfSwitch<Adapter> modelSwitch =
    new TdpfSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseSequenceNumber(SequenceNumber object)
      {
        return createSequenceNumberAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link no.hib.dpf.text.tdpf.SequenceNumber <em>Sequence Number</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createSequenceNumberAdapter()
  {
    return null;
  }

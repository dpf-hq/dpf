		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSpecificationAccess().getAlternatives_2(), "rule__Specification__Alternatives_2");
					...
					put(grammarAccess.getSpecificationAccess().getGroup_2_1(), "rule__Specification__Group_2_1__0");
					...
					put(grammarAccess.getSpecificationAccess().getGroup_8_2_1(), "rule__Specification__Group_8_2_1__0");
					...
					put(grammarAccess.getSignatureAccess().getGroup_1(), "rule__Signature__Group_1__0");
					...
					put(grammarAccess.getExtSubTGraphAccess().getGroup_7(), "rule__ExtSubTGraph__Group_7__0");
					put(grammarAccess.getExtSubTGraphAccess().getGroup_7_1(), "rule__ExtSubTGraph__Group_7_1__0");
					...
					put(grammarAccess.getModelAccess().getCommandsAssignment_2_0(), "rule__Model__CommandsAssignment_2_0");
					put(grammarAccess.getModelAccess().getCommandsAssignment_2_1(), "rule__Model__CommandsAssignment_2_1");
					...
					put(grammarAccess.getSpecificationAccess().getTypeAssignment_2_0(), "rule__Specification__TypeAssignment_2_0");
					put(grammarAccess.getSpecificationAccess().getTypeAssignment_2_1_1(), "rule__Specification__TypeAssignment_2_1_1");
					put(grammarAccess.getSpecificationAccess().getConstraintSemanticAssignment_2_1_3(), "rule__Specification__ConstraintSemanticAssignment_2_1_3");
					...
					put(grammarAccess.getSpecificationAccess().getConstraintsAssignment_8_2_0(), "rule__Specification__ConstraintsAssignment_8_2_0");
					put(grammarAccess.getSpecificationAccess().getConstraintsAssignment_8_2_1_1(), "rule__Specification__ConstraintsAssignment_8_2_1_1");
					put(grammarAccess.getChoosenSpecificationAccess().getIdAssignment(), "rule__ChoosenSpecification__IdAssignment");
					put(grammarAccess.getSequenceNumberAccess().getNextNumberAssignment(), "rule__SequenceNumber__NextNumberAssignment");
					...
					put(grammarAccess.getSignatureAccess().getConstraintSemanticsAssignment_0(), "rule__Signature__ConstraintSemanticsAssignment_0");
					put(grammarAccess.getSignatureAccess().getConstraintSemanticsAssignment_1_1(), "rule__Signature__ConstraintSemanticsAssignment_1_1");
					...
					put(grammarAccess.getConstraintSemanticAccess().getOclAssignment_5(), "rule__ConstraintSemantic__OclAssignment_5");
					...
					put(grammarAccess.getExtSubTGraphAccess().getElementsAssignment_7_0(), "rule__ExtSubTGraph__ElementsAssignment_7_0");
					put(grammarAccess.getExtSubTGraphAccess().getElementsAssignment_7_1_1(), "rule__ExtSubTGraph__ElementsAssignment_7_1_1");

 ...
 *   <li>{@link no.hib.dpf.diagram.DArrow#getDOutgoingAttributes <em>DOutgoing Attributes</em>}</li>
 * </ul>
 * </p>
 *
...
public interface DArrow extends DElement {
	 ...
	 * It is bidirectional and its opposite is '{@link no.hib.dpf.diagram.DArrowDAttribute#getDSource <em>DSource</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see no.hib.dpf.diagram.DiagramPackage#getDArrow_DOutgoingAttributes()
	 * @see no.hib.dpf.diagram.DArrowDAttribute#getDSource
	 * @model opposite="dSource"
	 * @generated
	 */
	EList<DArrowDAttribute> getDOutgoingAttributes();

...
public class DiagramAdapterFactory extends AdapterFactoryImpl {
	...
	protected DiagramSwitch<Adapter> modelSwitch =
		new DiagramSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDDataNode(DDataNode object) {
				return createDDataNodeAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseDNodeDAttribute(DNodeDAttribute object) {
				return createDNodeDAttributeAdapter();
			}
			@Override
			public Adapter caseDArrowDAttribute(DArrowDAttribute object) {
				return createDArrowDAttributeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link no.hib.dpf.diagram.DNodeDAttribute <em>DNode DAttribute</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link no.hib.dpf.diagram.DArrowDAttribute <em>DArrow DAttribute</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link no.hib.dpf.diagram.DDataNode <em>DData Node</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

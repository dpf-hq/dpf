...
public interface VisualPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int VNODE__SHADOW = VELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int VNODE_FEATURE_COUNT = VELEMENT_FEATURE_COUNT + 4;
	...
	/**
	 * Returns the meta object for the attribute '{@link no.hib.dpf.visual.VNode#isShadow <em>Shadow</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Shadow</em>'.
	 * @see no.hib.dpf.visual.VNode#isShadow()
	 * @see #getVNode()
	 * @generated
	 */
	EAttribute getVNode_Shadow();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute VNODE__SHADOW = eINSTANCE.getVNode_Shadow();

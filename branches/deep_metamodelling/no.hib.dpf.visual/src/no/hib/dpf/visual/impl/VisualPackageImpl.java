...
public class VisualPackageImpl extends EPackageImpl implements VisualPackage {
	 ...
	 */
	@Override
	public EAttribute getVNode_Shadow() {
		return (EAttribute)vNodeEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(vNodeEClass, VNODE__SHADOW);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getVNode_Shadow(), ecorePackage.getEBoolean(), "shadow", null, 0, 1, VNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

...
public interface CoreFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Arrow Attribute</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Arrow Attribute</em>'.
	 * @generated
	 */
	ArrowAttribute createArrowAttribute();
	...
	DataNode createConstantDataNode();

	NodeAttribute createConstantNodeAttribute();
	ArrowAttribute createConstantArrowAttribute();

	DataNode createDefaultDataNode();

	ArrowAttribute createDefaultArrowAttribute();

	NodeAttribute createDefaultNodeAttribute();

...
import no.hib.dpf.editor.commands.datanode.DDataNodeCreateCommand;
import no.hib.dpf.editor.commands.datanode.DDataNodeMoveCommand;
import no.hib.dpf.editor.commands.datanode.DDataNodeResizeCommand;
import no.hib.dpf.editor.commands.node.DNodeCreateCommand;
import no.hib.dpf.editor.commands.node.DNodeMoveCommand;
import no.hib.dpf.editor.commands.node.DNodeResizeCommand;
		...
		if(request instanceof CreateConnectionRequest){
			...
			if(host instanceof DGraphEditPart){
				...
				if(REQ_CONNECTION_START.equals(request.getType())){
					...
					else if(((CreateConnectionRequest) request).getNewObjectType() == DArrow.class){

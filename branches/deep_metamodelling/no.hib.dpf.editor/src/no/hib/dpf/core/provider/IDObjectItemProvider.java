 ...
 * @generated
 */
public class IDObjectItemProvider extends ItemProviderAdapter implements
	...
	protected ItemPropertyDescriptor createItemPropertyDescriptor(
		...
		if (this instanceof ArrowItemProvider)
			category = DPFCoreConstants.ARROW_CATEGORY;
		else if (this instanceof NodeItemProvider)
			category = DPFCoreConstants.NODE_CATEGORY;
		else if (this instanceof GraphItemProvider)
			category = DPFCoreConstants.GRAPH_CATEGORY;

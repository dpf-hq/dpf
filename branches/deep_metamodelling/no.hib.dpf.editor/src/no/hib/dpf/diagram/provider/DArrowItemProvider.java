		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 true,
				 null,
				 DPFCoreConstants.DARROW_CATEGORY,
				 null));
	}
	...
	protected void addDOutgoingAttributesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DArrow_dOutgoingAttributes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DArrow_dOutgoingAttributes_feature", "_UI_DArrow_type"),
				 DiagramPackage.Literals.DARROW__DOUTGOING_ATTRIBUTES,
				 true,
				 false,
				 true,
				 null,

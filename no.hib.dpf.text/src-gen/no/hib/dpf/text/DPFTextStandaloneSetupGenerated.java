...
public class DPFTextStandaloneSetupGenerated implements ISetup {
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://no.hib.dpf/dpf-text")) {
		...
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put("tdpf", resourceFactory);
		org.eclipse.xtext.resource.IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("tdpf", serviceProvider);
